...
namespace pocketseller.droid.Helper
{
    public class CTools
    {
        ...
        {
            CreateDialog(objContext, objView, objInflater, iResourceTextView, strTitle, strCurrentValue, delPositivAction, orderline.droid.Resource.Layout.InputDigit, orderline.droid.Resource.Id.inputdigit_edittext);
        }
        ...
        {
            CreateDialog(objContext, objView, objInflater, iResourceTextView, strTitle, strCurrentValue, delPositivAction, orderline.droid.Resource.Layout.InputDate, orderline.droid.Resource.Id.inputdate_edittext);
        }
        ...
        {
            CreateDialog(objContext, objView, objInflater, iResourceTextView, strTitle, strCurrentValue, delPositivAction, orderline.droid.Resource.Layout.InputText, orderline.droid.Resource.Id.inputtext_edittext);
        }
        ...
        public static void InitActionBar(ActionBar objActionBar, string strTitle)
        {
            ...
            objActionBar.ThemedContext.SetTheme(orderline.droid.Resource.Style.Theme_Pocketsellertheme1_Widget);
