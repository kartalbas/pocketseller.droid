...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class ImportToFacturaFragment : BaseTabWidgetFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objView = this.BindingInflate(orderline.droid.Resource.Layout.ImportToFacturaFragment, null);
            ...
            _objListView = objView.FindViewById<MvxListView>(orderline.droid.Resource.Id.stocktodelete_listview);
