...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class DocumentsFragment : BaseTabHostFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            CTools.CreateTab(_objFragmentTabHost, typeof(DocumentsNewFragment), DocumentsViewModel.LabelNewOrder, orderline.droid.Resource.Drawable.documentsfragment_tab_newdocument);
            CTools.CreateTab(_objFragmentTabHost, typeof(DocumentsSentFragment), DocumentsViewModel.LabelSentOrder, orderline.droid.Resource.Drawable.documentsfragment_tab_sentdocument);
