...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class StockToPrintedFragment : BaseTabWidgetFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objView = this.BindingInflate(orderline.droid.Resource.Layout.StockToPrintFragment, null);
            ...
            _objListView = objView.FindViewById<MvxListView>(orderline.droid.Resource.Id.stocktoprint_listview);
