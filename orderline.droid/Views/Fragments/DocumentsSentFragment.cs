...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class DocumentsSentFragment : MvxFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objView = this.BindingInflate(orderline.droid.Resource.Layout.DocumentsSentFragment, null);
            ...
            _objListView = objView.FindViewById<MvxListView>(orderline.droid.Resource.Id.documentssentview_listview);
