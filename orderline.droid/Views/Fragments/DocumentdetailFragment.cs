...
namespace pocketseller.droid.Views.Fragments
{
    ...
    public sealed class DocumentdetailFragment : MvxDialogFragment<DocumentdetailViewModel>
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objDialogView = this.BindingInflate(orderline.droid.Resource.Layout.DocumentdetailFragment, null);
        ...
        {
            _objArticleLable = objView.FindViewById<TextView>(orderline.droid.Resource.Id.documentdetail_articlelable);
            _objArticleLable.LongClick += ArticleLableOnLongClick;
            _objArticleLable.Click += ArticleLableOnClick;

            _objLinearLayoutInput = objView.FindViewById<LinearLayout>(orderline.droid.Resource.Id.documentdetail_linearlayout_input);
            _objLinearLayoutInformation1 = objView.FindViewById<LinearLayout>(orderline.droid.Resource.Id.documentdetail_linearlayout_lastinformations1);
            _objLinearLayoutInformation2 = objView.FindViewById<LinearLayout>(orderline.droid.Resource.Id.documentdetail_linearlayout_lastinformations2);

            _objCount = objView.FindViewById<EditText>(orderline.droid.Resource.Id.documentdetail_edittext_count);
            ...
            _objAmount = objView.FindViewById<EditText>(orderline.droid.Resource.Id.documentdetail_edittext_amount);
            ...
            _objPrice = objView.FindViewById<EditText>(orderline.droid.Resource.Id.documentdetail_edittext_price);
            ...
            _objNextButton = objView.FindViewById<ImageButton>(orderline.droid.Resource.Id.documentdetail_imagebutton_next);
            _objNextButton.Click += NextOnClick;

            _objPreviousButton = objView.FindViewById<ImageButton>(orderline.droid.Resource.Id.documentdetail_imagebutton_previous);
