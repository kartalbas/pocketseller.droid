...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class DocumentsNewFragment : MvxFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objView = this.BindingInflate(orderline.droid.Resource.Layout.DocumentsNewFragment, null);
            ...
            _objListView = objView.FindViewById<MvxListView>(orderline.droid.Resource.Id.documentsnewview_listview);
