...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class DocumentInfoFragment : MvxFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objView = this.BindingInflate(orderline.droid.Resource.Layout.DocumentInfoFragment, null);
            ...
            _objEditText = objView.FindViewById<EditText>(orderline.droid.Resource.Id.documentinfo_textedit_info);
