...
namespace pocketseller.droid.Views
{
    ...
    public class DocumentView : MvxFragmentActivity
    {
        ...
        protected override void OnCreate(Bundle objInState)
        {
            ...
            SetContentView(orderline.droid.Resource.Layout.DocumentView);
            ...
            CTools.CreateTab(_objFragmentTabHost, typeof(DocumentAddressFragment), DocumentViewModel.DocumentAddressViewModel.LabelTitle, orderline.droid.Resource.Drawable.documentsfragment_tab_newdocument);
            CTools.CreateTab(_objFragmentTabHost, typeof(DocumentOrderFragment), DocumentViewModel.DocumentOrderViewModel.LabelTitle, orderline.droid.Resource.Drawable.documentsfragment_tab_sentdocument);
            CTools.CreateTab(_objFragmentTabHost, typeof(DocumentInfoFragment), DocumentViewModel.DocumentInfoViewModel.LabelTitle, orderline.droid.Resource.Drawable.documentsfragment_tab_sentdocument);
            CTools.CreateTab(_objFragmentTabHost, typeof(DocumentOutstandingFragment), DocumentViewModel.DocumentOutstandingViewModel.LabelTitle, orderline.droid.Resource.Drawable.documentsfragment_tab_sentdocument);
