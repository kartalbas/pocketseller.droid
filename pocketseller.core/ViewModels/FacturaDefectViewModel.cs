...
{
    public class FacturaDefectViewModel : BaseViewModel
    {
        public FacturaDefectViewModel(IDataService objDataService, IDocumentService objDocumentService, ISettingService objSettingService, ILanguageService objLanguageService, IMvxMessenger objMessenger)
        ...
        public override void Init()
        {
            ...
            LabelCorrectFactura = Language.CorrectFactura;
        ...
        private string _labelCorrectFactura;
        public string LabelCorrectFactura
        {
            get => _labelCorrectFactura;
            set { _labelCorrectFactura = value; RaisePropertyChanged(() => LabelCorrectFactura); }
        }
