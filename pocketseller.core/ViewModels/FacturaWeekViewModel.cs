...
{
    public class FacturaWeekViewModel : BaseViewModel
    {
        public FacturaWeekViewModel(IDataService objDataService, IDocumentService objDocumentService, ISettingService objSettingService, ILanguageService objLanguageService, IMvxMessenger objMessenger)
