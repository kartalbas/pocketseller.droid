...
namespace pocketseller.droid.Helper
{
    ...
    public class ActionBarDrawerToggleWrapper : ActionBarDrawerToggle
    {
        public ActionBarDrawerToggleWrapper(Activity activity, DrawerLayout drawerLayout, int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes)
