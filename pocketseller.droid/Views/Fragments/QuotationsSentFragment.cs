...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class QuotationsSentFragment : MvxFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objView = this.BindingInflate(pocketseller.droid.Resource.Layout.QuotationsSentFragment, null);
            ...
            _objListView = objView.FindViewById<MvxListView>(pocketseller.droid.Resource.Id.quotationsent_listview);
