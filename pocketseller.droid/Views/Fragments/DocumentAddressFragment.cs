...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class DocumentAddressFragment : MvxFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objView = this.BindingInflate(pocketseller.droid.Resource.Layout.DocumentAddressFragment, null);
            ...
            var objAutoCompleteTextView = objView.FindViewById<MvxAutoCompleteTextView>(pocketseller.droid.Resource.Id.selectionaddresssearchbox);
            //objAutoCompleteTextView.Context.SetTheme(pocketseller.droid.Resource.Style.AutoCompleteTextViewHoloDark);
