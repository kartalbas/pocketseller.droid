            ...
            lock (LOCK)
            {
                Activity.RunOnUiThread(() =>
                {
                    ...
                    if (ShowPrintButton && EnablePrintButton)
                        objMenu.Add("")
                            .SetIcon(pocketseller.droid.Resource.Drawable.ic_action_upload_dark)
                            .SetOnMenuItemClickListener(new DelegatedMenuItemListener(OnPrintClicked))
                            .SetShowAsAction(ShowAsAction.Always);

                    if (ShowDaysButton && EnableDaysButton)
                        objMenu.Add("")
                            .SetIcon(pocketseller.droid.Resource.Drawable.ic_action_search_dark)
                    ...
                    if(RefreshDefects)
                    {
                        if (ShowMenuItems)
                            objMenu.Add("")
                                .SetIcon(pocketseller.droid.Resource.Drawable.ic_action_refresh_dark)
