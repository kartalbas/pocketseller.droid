...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class DocumentOutstandingFragment : MvxFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objView = this.BindingInflate(pocketseller.droid.Resource.Layout.DocumentOutstandingFragment, null);
            ...
            _objListView = objView.FindViewById<MvxListView>(pocketseller.droid.Resource.Id.documentoutstandingpayments_listview);
