...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class QuotationsNewFragment : MvxFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objView = this.BindingInflate(pocketseller.droid.Resource.Layout.QuotationsNewFragment, null);
            ...
            _objListView = objView.FindViewById<MvxListView>(pocketseller.droid.Resource.Id.quotationsnew_listview);
