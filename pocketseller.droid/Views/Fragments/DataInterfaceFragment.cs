...
namespace pocketseller.droid.Views.Fragments
{
    public sealed class DataInterfaceFragment : MvxFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var objThisView = this.BindingInflate(pocketseller.droid.Resource.Layout.DataInterfaceView, null);

            LogTag = GetType().ToString();
            _objDataService = (CDataService)Mvx.IoCProvider.Resolve<IDataService>();

            var objButtonAll = objThisView.FindViewById<Button>(pocketseller.droid.Resource.Id.datainterface_button_renewall);
            objButtonAll.Click += ButtonAllOnClick;

            var objUpdateAll = objThisView.FindViewById<Button>(pocketseller.droid.Resource.Id.datainterface_button_update);
            objUpdateAll.Click += ButtonUpdateOnClick;

            var objStatus = objThisView.FindViewById<TextView>(pocketseller.droid.Resource.Id.datainterface_status);
