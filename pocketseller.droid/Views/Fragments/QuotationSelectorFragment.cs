...
namespace pocketseller.droid.Views.Fragments
{
    ...
    public sealed class QuotationSelectorFragment : MvxDialogFragment<QuotationSelectorViewModel>
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            _view = this.BindingInflate(pocketseller.droid.Resource.Layout.QuotationSelectorFragment, null);
            _buttonCancel = _view.FindViewById<Button>(pocketseller.droid.Resource.Id.quotationselector_cancel);
            _buttonCancel.Click += (sender, e) => RestoreAndExit();

            _buttonOK = _view.FindViewById<Button>(pocketseller.droid.Resource.Id.quotationselector_ok);
            ...
            _objListView = _view.FindViewById<MvxListView>(pocketseller.droid.Resource.Id.quotationselector_listview);
