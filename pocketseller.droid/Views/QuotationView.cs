...
namespace pocketseller.droid.Views
{
    ...
    public class QuotationView : MvxFragmentActivity
    {
        ...
        protected override void OnCreate(Bundle objInState)
        {
            ...
            SetContentView(pocketseller.droid.Resource.Layout.QuotationView);

            QuotationViewModel.SetDefaultDatesCommand.Execute(null);

            //Init Autocomplete
            var objAutoCompleteTextView = FindViewById<MvxAutoCompleteTextView>(pocketseller.droid.Resource.Id.selectionarticlesearchbox);
            ...
            //Init ListView
            _objListView = FindViewById<MvxListView>(pocketseller.droid.Resource.Id.quotation_listview);
            ...
            _objTextViewStart = FindViewById<TextView>(pocketseller.droid.Resource.Id.quotation_startdatetime);
            _objTextViewStart.Click += (sender, args) => ShowDialog(DATE_DIALOG_START_ID);
            _objTextViewStop = FindViewById<TextView>(pocketseller.droid.Resource.Id.quotation_stopdatetime);
